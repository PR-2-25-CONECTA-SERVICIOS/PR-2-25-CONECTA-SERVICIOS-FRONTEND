...
//   const showSheet = () => Animated.timing(bottom, { toValue: 1, duration: 260, easing: Easing.out(Easing.cubic), useNativeDriver: true }).start();
//   const hideSheet = () => Animated.timing(bottom, { toValue: 0, duration: 220, easing: Easing.in(Easing.cubic), useNativeDriver: true }).start();
...
//       >
//         {MOCK.map(m => (
//           <Pin key={m.id} item={m} selected={selected?.id===m.id}
